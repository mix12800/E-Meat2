<template>
  <div class="boxed_wrapper ltr">
          ...
          <div class="outer-box clearfix">
            ...
            <div class="menu-area pull-right">
              ...
              <ul class="menu-right-content pull-left clearfix">
                <li class="user-box">
                  <a href="/"><i class="flaticon-user-symbol-of-thin-outline"></i></a>
                </li>
        ...
        <div class="auto-container">
          <div class="outer-box clearfix">
            <figure class="logo-box pull-left">
              <a href="/"><img src="/assets/images/small-logo.png" alt="" /></a>
            </figure>
            <div class="menu-area pull-right">
    ...
    <div class="mobile-menu">
      ...
      <nav class="menu-box">
        <div class="nav-logo">
          <a href="/"><img src="/assets/images/logo-2.png" alt="" title="" /></a>
        </div>
      ...
      <div class="auto-container">
        <div class="clients-carousel owl-carousel owl-theme owl-dots-none owl-nav-none">
          <figure class="logo-image">
            <a href="/"><img src="/assets/images/clients/clients-logo-1.png" alt="" /></a>
          </figure>
          <figure class="logo-image">
            <a href="/"><img src="/assets/images/clients/clients-logo-2.png" alt="" /></a>
          </figure>
          <figure class="logo-image">
            <a href="/"><img src="/assets/images/clients/clients-logo-3.png" alt="" /></a>
          </figure>
          <figure class="logo-image">
            <a href="/"><img src="/assets/images/clients/clients-logo-4.png" alt="" /></a>
          </figure>
          <figure class="logo-image">
            <a href="/"><img src="/assets/images/clients/clients-logo-5.png" alt="" /></a>
          </figure>
        </div>
      </div>
    </section>
            ...
            <div class="shop-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
              <div class="inner-box">
                <figure class="image-box">
                  ...
                  <ul class="list clearfix">
                    <li>
                      <a href="shop-1.html"><i class="flaticon-cart"></i></a>
                    </li>
            ...
            <div class="inner-box">
              ...
              <div class="lower-content">
                <div class="inner">
                  ...
                  <div class="link">
                    <a href="/"><i class="flaticon-right"></i></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="two-column-carousel owl-carousel owl-theme owl-dots-none">
          <div class="testimonial-block-one">
            <div class="inner-box">
              ...
              <p>
                Slore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
          ...
          <div class="testimonial-block-one">
            <div class="inner-box">
              <div class="icon-box"><i class="flaticon-quote"></i></div>
              <p>
                Asi enim ad minim veniam, quis nostrud exerci tation uLorem ipsum dolor
      ...
      <div class="auto-container">
            ...
            <div class="row clearfix">
              <div class="col-lg-4 col-md-6 col-sm-12 footer-column">
                <div class="footer-widget logo-widget">
                  ...
                  <div class="text">
                    <p>
                      The probability of someone needing your services or wantinLorem
        ...
        <div class="footer-bottom clearfix">
          <div class="copyright pull-left">
            <h5>&copy;2020 CopyRight <a href="/">Example</a>. All rights reserved.</h5>
          </div>
